...
export const DIVISIONS = [
  { id: 'dhaka',      name: 'Dhaka',      tagline: 'Capital',     hot: true,
    image: '/image/Divition/Dhaka-Division.png',
  ...
  { id: 'chittagong', name: 'Chattogram', tagline: 'Port City',
    image: '/image/Divition/Chattogram.png',
