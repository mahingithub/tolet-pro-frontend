...
import {
  ...
  File, Eye, Megaphone, FileSpreadsheet, Phone, Bot, CheckCheck, Video,
  Activity, Crown, Lock, Sparkles, DollarSign, Wallet,
  XCircle, AlertCircle, RefreshCw, ChevronDown, ChevronLeft, ChevronRight, MinusCircle,
...
import { sortByBuildingOrder } from '../utils/buildingScope';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#eaeff5] font-sans relative overflow-hidden text-gray-900 selection:bg-[#ba0036] selection:text-white">
      ...
      <main className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12 pt-1 md:pt-2 relative z-10 custom-scrollbar overflow-y-auto pb-24">
        ...
        {/* 🔴 HOST DASHBOARD — one architecture, desktop and mobile alike.
            The whole layout lives in host-dashboard/DashboardTab.jsx; this
            passes it data and handlers. The screen used to be inline here, and
            written out almost verbatim in BOTH branches of a
            `properties.length > 0` ternary — one ledger change meant two
            edits, with one branch always a candidate to be left behind. */}
        {activeTab === 'dashboard' && (
          <DashboardTab
            language={language}
            ...
            bookings={bookings}
            hidePaymentPromo={hidePaymentPromo}
            setHidePaymentPromo={setHidePaymentPromo}
            setActiveTab={setActiveTab}
            pendingRentCount={pendingRentCount}
            defaultPaymentMethod={defaultPaymentMethod}
            canClaimShareTrial={canClaimShareTrial}
            ...
            openModal={openModal}
            dashboardPropTitle={dashboardPropTitle}
            dashboardProperties={dashboardProperties}
            propertyLoadError={propertyLoadError}
            retryLoadProperties={retryLoadProperties}
            isRecent={isRecent}
