                        ...
                        {yearMonths.map(k => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {cellStatus === 'current' && <span className="mt-0.5 w-1 h-1 rounded-full bg-sky-500 animate-pulse" />}
                            </button>
                          );
                        })}
                      </div>
              ...
              <aside className="lg:col-span-4 w-full flex flex-col gap-3 lg:gap-5 lg:h-full lg:overflow-y-auto custom-scrollbar lg:pt-1 lg:pb-4 lg:pr-1">
                ...
                {!(landlordProfile?.buildingMode === 'multi' && !currentBuildingId) && (
                  ...
                  <div className="grid grid-cols-2 gap-y-2 gap-x-3 text-[10px] font-bold text-gray-600">
                    ...
                    <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-md bg-sky-100 border border-sky-300 inline-block"></span>{language === 'বাংলা' ? 'চলতি মাস' : 'This month'}</span>
