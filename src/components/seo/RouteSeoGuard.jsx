...
import { PUBLIC_PAGE_SEO } from '../../seo/staticPages';
...
/** Public pages whose components don't manage their own head — copy in src/seo/staticPages.js. */
const PUBLIC_ROUTE_SEO = PUBLIC_PAGE_SEO;
